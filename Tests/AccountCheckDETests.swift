...
class AccountCheckDETests: XCTestCase {
  ...
  func testChecksums() {
    ...
    // 17
    XCTAssertFalse(IBANtools.isValidAccount("0", bankCode: "10110600", countryCode: "de").0, "Rule 17.0");
    ...
    // 24
    XCTAssertFalse(IBANtools.isValidAccount("0", bankCode: "37010050", countryCode: "de").0, "Rule 24.0");
    ...
    // 29
    XCTAssertFalse(IBANtools.isValidAccount("0", bankCode: "29050000", countryCode: "de").0, "Rule 29.0");
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0000156079", bankCode: "33060592", countryCode: "de").0, "Rule 51.4"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0012345678", bankCode: "33060592", countryCode: "de").0, "Rule 51.8"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0023456783", bankCode: "33060592", countryCode: "de").0, "Rule 51.11"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0076543211", bankCode: "33060592", countryCode: "de").0, "Rule 51.12"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0123412345", bankCode: "33060592", countryCode: "de").0, "Rule 51.15"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("67493647", bankCode: "33060592", countryCode: "de").0, "Rule 51.16"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0099345678", bankCode: "33060592", countryCode: "de").0, "Rule 51.22"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0099345678", bankCode: "33060592", countryCode: "de").0, "Rule 51.26"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0099100110", bankCode: "33060592", countryCode: "de").0, "Rule 51.27"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0199100040", bankCode: "33060592", countryCode: "de").0, "Rule 51.28"); // must fail

    // 52
    XCTAssertFalse(IBANtools.isValidAccount("0", bankCode: "13051172", countryCode: "de").0, "Rule 52.0");
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0", bankCode: "16052072", countryCode: "de").0, "Rule 53.0");
    XCTAssert(IBANtools.isValidAccount("382432256", bankCode: "16052082", countryCode: "de").0, "Rule 53.1");

    // 54
    XCTAssertFalse(IBANtools.isValidAccount("0", bankCode: "11111115", countryCode: "de").0, "Rule 54.0");
    ...
    // 56
    XCTAssertFalse(IBANtools.isValidAccount("0", bankCode: "51051000", countryCode: "de").0, "Rule 56.0");
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0", bankCode: "30020900", countryCode: "de").0, "Rule 57.0");
    ...
    XCTAssertFalse(IBANtools.isValidAccount("5302707782", bankCode: "30020900", countryCode: "de").0, "Rule 57.13"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("6412121212", bankCode: "30020900", countryCode: "de").0, "Rule 57.14"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("1813499124", bankCode: "30020900", countryCode: "de").0, "Rule 57.15"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("2206735010", bankCode: "30020900", countryCode: "de").0, "Rule 57.16"); // must fail
    ...
    // 61
    XCTAssertFalse(IBANtools.isValidAccount("0", bankCode: "25621327", countryCode: "de").0, "Rule 61.0");
    ...
    // 62
    XCTAssertFalse(IBANtools.isValidAccount("0", bankCode: "11111116", countryCode: "de").0, "Rule 62.0");
    XCTAssert(IBANtools.isValidAccount("5 0 2 9 0 7 6 7 0 1", bankCode: "11111116", countryCode: "de").0, "Rule 62.1");

    // 63
    XCTAssertFalse(IBANtools.isValidAccount("0", bankCode: "25770024", countryCode: "de").0, "Rule 63.0");
    ...
    // 66
    XCTAssertFalse(IBANtools.isValidAccount("0", bankCode: "50120500", countryCode: "de").0, "Rule 66.0");
    ...
    // 68
    XCTAssertFalse(IBANtools.isValidAccount("0", bankCode: "20030000", countryCode: "de").0, "Rule 68.0");
    ...
    XCTAssertFalse(IBANtools.isValidAccount("121212", bankCode: "50090500", countryCode: "de").0, "Rule 73.14"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("987654321", bankCode: "50090500", countryCode: "de").0, "Rule 73.15"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0099345678", bankCode: "50090500", countryCode: "de").0, "Rule 73.16"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0099100110", bankCode: "50090500", countryCode: "de").0, "Rule 73.17"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0199100040", bankCode: "50090500", countryCode: "de").0, "Rule 73.18"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("1011", bankCode: "21050170", countryCode: "de").0, "Rule 74.7"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("26265", bankCode: "21050170", countryCode: "de").0, "Rule 74.8"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("18002118", bankCode: "21050170", countryCode: "de").0, "Rule 74.9"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("6160000024", bankCode: "21050170", countryCode: "de").0, "Rule 74.10"); // must fail
    ...
    // 79
    XCTAssertFalse(IBANtools.isValidAccount("0", bankCode: "11111119", countryCode: "de").0, "Rule 79.0");
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0099345678", bankCode: "11111120", countryCode: "de").0, "Rule 80.6"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0099345678", bankCode: "11111120", countryCode: "de").0, "Rule 80.10"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0099100110", bankCode: "11111120", countryCode: "de").0, "Rule 80.11"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0199100040", bankCode: "11111120", countryCode: "de").0, "Rule 80.12"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0099345678", bankCode: "70090500", countryCode: "de").0, "Rule 81.6"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0099345678", bankCode: "70090500", countryCode: "de").0, "Rule 81.10"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0099100110", bankCode: "70090500", countryCode: "de").0, "Rule 81.11"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0199100040", bankCode: "70090500", countryCode: "de").0, "Rule 81.12"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("240965", bankCode: "72090500", countryCode: "de").0, "Rule 84.4"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("350980", bankCode: "72090500", countryCode: "de").0, "Rule 84.5"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("461053", bankCode: "72090500", countryCode: "de").0, "Rule 84.6"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("240965", bankCode: "72090500", countryCode: "de").0, "Rule 84.10"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("350980", bankCode: "72090500", countryCode: "de").0, "Rule 84.11"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("461053", bankCode: "72090500", countryCode: "de").0, "Rule 84.12"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("240965", bankCode: "72090500", countryCode: "de").0, "Rule 84.16"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("350980", bankCode: "72090500", countryCode: "de").0, "Rule 84.17"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("461053", bankCode: "72090500", countryCode: "de").0, "Rule 84.18"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0099345678", bankCode: "72090500", countryCode: "de").0, "Rule 84.6"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0099345678", bankCode: "72090500", countryCode: "de").0, "Rule 84.10"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0099100110", bankCode: "72090500", countryCode: "de").0, "Rule 84.11"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0199100040", bankCode: "72090500", countryCode: "de").0, "Rule 84.12"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0099345678", bankCode: "11111123", countryCode: "de").0, "Rule 84.6"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0099345678", bankCode: "11111123", countryCode: "de").0, "Rule 84.10"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0099100110", bankCode: "11111123", countryCode: "de").0, "Rule 84.11"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0199100040", bankCode: "11111123", countryCode: "de").0, "Rule 84.12"); // must fail

    // 87
    XCTAssertFalse(IBANtools.isValidAccount("0", bankCode: "60090800", countryCode: "de").0, "Rule 84.0");
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0099345678", bankCode: "60090800", countryCode: "de").0, "Rule 84.12"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0099345678", bankCode: "60090800", countryCode: "de").0, "Rule 84.16"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0099100110", bankCode: "60090800", countryCode: "de").0, "Rule 84.17"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0199100040", bankCode: "60090800", countryCode: "de").0, "Rule 84.18"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0001924592", bankCode: "55090500", countryCode: "de").0, "Rule 90.3"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0000901568", bankCode: "55090500", countryCode: "de").0, "Rule 90.6"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0000820487", bankCode: "55090500", countryCode: "de").0, "Rule 90.9"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0000726393", bankCode: "55090500", countryCode: "de").0, "Rule 90.12"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0000924591", bankCode: "55090500", countryCode: "de").0, "Rule 90.15"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0003865964", bankCode: "55090500", countryCode: "de").0, "Rule 90.18"); // must fail
    XCTAssert(IBANtools.isValidAccount("0099100002", bankCode: "55090500", countryCode: "de").0, "Rule 90.19"); // method F
    XCTAssertFalse(IBANtools.isValidAccount("0099100007", bankCode: "55090500", countryCode: "de").0, "Rule 90.20"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("8840017000", bankCode: "57090900", countryCode: "de").0, "Rule 91.4"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("8840023000", bankCode: "57090900", countryCode: "de").0, "Rule 91.5"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("8840041000", bankCode: "57090900", countryCode: "de").0, "Rule 91.6"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("8840014000", bankCode: "57090900", countryCode: "de").0, "Rule 91.10"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("8840026000", bankCode: "57090900", countryCode: "de").0, "Rule 91.11"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("8840011000", bankCode: "57090900", countryCode: "de").0, "Rule 91.17"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("8840025000", bankCode: "57090900", countryCode: "de").0, "Rule 91.18"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("8840062000", bankCode: "57090900", countryCode: "de").0, "Rule 91.19"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("8840010000", bankCode: "57090900", countryCode: "de").0, "Rule 91.23"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("8840057000", bankCode: "57090900", countryCode: "de").0, "Rule 91.24"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("42", bankCode: "11111127", countryCode: "de").0, "Rule A0.6"); // Must fail
    XCTAssert(IBANtools.isValidAccount("142", bankCode: "11111127", countryCode: "de").0, "Rule A0.6");

    // A1
    XCTAssertFalse(IBANtools.isValidAccount("0", bankCode: "73362500", countryCode: "de").0, "Rule A1.0");
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0110030005", bankCode: "73362500", countryCode: "de").0, "Rule A1.4"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0010030998", bankCode: "73362500", countryCode: "de").0, "Rule A1.5"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0000030005", bankCode: "73362500", countryCode: "de").0, "Rule A1.6"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("1234567890", bankCode: "21051275", countryCode: "de").0, "Rule A2.5"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0123456789", bankCode: "21051275", countryCode: "de").0, "Rule A2.6"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("6543217890", bankCode: "25050180", countryCode: "de").0, "Rule A3.5"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0543216789", bankCode: "25050180", countryCode: "de").0, "Rule A3.6"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("6543217890", bankCode: "25050180", countryCode: "de").0, "Rule A3.10"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0543216789", bankCode: "25050180", countryCode: "de").0, "Rule A3.11"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("8623420004,", bankCode: "25090608", countryCode: "de").0, "Rule A4.3"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("8623420000,", bankCode: "25090608", countryCode: "de").0, "Rule A4.6"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0000399443", bankCode: "25090608", countryCode: "de").0, "Rule A4.17"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0000553313", bankCode: "25090608", countryCode: "de").0, "Rule A4.18"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("9941510002,", bankCode: "76450000", countryCode: "de").0, "Rule A5.5"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("9961230020,", bankCode: "76450000", countryCode: "de").0, "Rule A5.6"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0000251438", bankCode: "76450000", countryCode: "de").0, "Rule A5.11"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0007948345", bankCode: "76450000", countryCode: "de").0, "Rule A5.12"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("860000817,", bankCode: "11111128", countryCode: "de").0, "Rule A6.3"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("810033652,", bankCode: "11111128", countryCode: "de").0, "Rule A6.4"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("305888", bankCode: "11111128", countryCode: "de").0, "Rule A6.10"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("200071280", bankCode: "11111128", countryCode: "de").0, "Rule A6.11"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("209010892,", bankCode: "11111129", countryCode: "de").0, "Rule A7.3"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("209010893,", bankCode: "11111129", countryCode: "de").0, "Rule A7.4"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("209010893", bankCode: "11111129", countryCode: "de").0, "Rule A7.8"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("7436666", bankCode: "11111130", countryCode: "de").0, "Rule A8.10"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("7436677", bankCode: "11111130", countryCode: "de").0, "Rule A8.11"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0003503391", bankCode: "11111130", countryCode: "de").0, "Rule A8.12"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0001340966", bankCode: "11111130", countryCode: "de").0, "Rule A8.13"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0099345678", bankCode: "11111130", countryCode: "de").0, "Rule A8.17"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0099345678", bankCode: "11111130", countryCode: "de").0, "Rule A8.21"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0099100110", bankCode: "11111130", countryCode: "de").0, "Rule A8.22"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0199100040", bankCode: "11111130", countryCode: "de").0, "Rule A8.23"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("86724,", bankCode: "11111131", countryCode: "de").0, "Rule A9.3"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("86724", bankCode: "11111131", countryCode: "de").0, "Rule A9.7"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("292497", bankCode: "11111131", countryCode: "de").0, "Rule A9.8"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("30767208", bankCode: "11111131", countryCode: "de").0, "Rule A9.9"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("600000606,", bankCode: "11111132", countryCode: "de").0, "Rule B0.4"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("1000000405", bankCode: "11111132", countryCode: "de").0, "Rule B0.10"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("1035791539", bankCode: "11111132", countryCode: "de").0, "Rule B0.11"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("7414398260,", bankCode: "25950001", countryCode: "de").0, "Rule B1.3"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0123456789", bankCode: "25950001", countryCode: "de").0, "Rule B1.5"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("2345678901,", bankCode: "25950001", countryCode: "de").0, "Rule B1.6"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("5678901234,", bankCode: "25950001", countryCode: "de").0, "Rule B1.7"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0123456789", bankCode: "25950001", countryCode: "de").0, "Rule B1.10"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("2345678901", bankCode: "25950001", countryCode: "de").0, "Rule B1.11"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("5678901234", bankCode: "25950001", countryCode: "de").0, "Rule B1.12"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0020012399", bankCode: "54051660", countryCode: "de").0, "Rule B2.5"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0080012347", bankCode: "54051660", countryCode: "de").0, "Rule B2.6"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0080012370,", bankCode: "54051660", countryCode: "de").0, "Rule B2.7"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0932100027,", bankCode: "54051660", countryCode: "de").0, "Rule B2.8"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("3310123454,", bankCode: "54051660", countryCode: "de").0, "Rule B2.9"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("8000990057", bankCode: "54051660", countryCode: "de").0, "Rule B2.12"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("8011000126", bankCode: "54051660", countryCode: "de").0, "Rule B2.13"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("9000481800", bankCode: "54051660", countryCode: "de").0, "Rule B2.14"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("9980480111", bankCode: "54051660", countryCode: "de").0, "Rule B2.15"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0002799899", bankCode: "66090800", countryCode: "de").0, "Rule B3.6"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("1000000111", bankCode: "66090800", countryCode: "de").0, "Rule B3.7"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("9635100101", bankCode: "66090800", countryCode: "de").0, "Rule B3.10"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("9730300100", bankCode: "66090800", countryCode: "de").0, "Rule B3.11"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("9941510002", bankCode: "11111133", countryCode: "de").0, "Rule B4.5"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("9961230020", bankCode: "11111133", countryCode: "de").0, "Rule B4.6"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0000251438", bankCode: "11111133", countryCode: "de").0, "Rule B4.10"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0007948345", bankCode: "11111133", countryCode: "de").0, "Rule B4.11"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0000159590", bankCode: "11111133", countryCode: "de").0, "Rule B4.12"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("7414398260", bankCode: "37050299", countryCode: "de").0, "Rule B5.5"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("8347251693", bankCode: "37050299", countryCode: "de").0, "Rule B5.6"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("2345678901", bankCode: "37050299", countryCode: "de").0, "Rule B5.8"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("5678901234", bankCode: "37050299", countryCode: "de").0, "Rule B5.9"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("9000293707", bankCode: "37050299", countryCode: "de").0, "Rule B5.10"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0159004165", bankCode: "37050299", countryCode: "de").0, "Rule B5.14"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0023456787", bankCode: "37050299", countryCode: "de").0, "Rule B5.15"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0056789018", bankCode: "37050299", countryCode: "de").0, "Rule B5.16"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("3045000333", bankCode: "37050299", countryCode: "de").0, "Rule B6.17"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("9111000000", bankCode: "80053762", countryCode: "de").0, "Rule B6.35"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0269456780", bankCode: "80053762", countryCode: "de").0, "Rule B6.4"); // must fail

    XCTAssert(IBANtools.isValidAccount("487310018", bankCode: "80053782", countryCode: "de").0, "Rule B6.5");
    XCTAssertFalse(IBANtools.isValidAccount("477310018", bankCode: "80053762", countryCode: "de").0, "Rule B6.6"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0001057886", bankCode: "50010700", countryCode: "de").0, "Rule B7.10"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0003815570", bankCode: "50010700", countryCode: "de").0, "Rule B7.11"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0005620516", bankCode: "50010700", countryCode: "de").0, "Rule B7.12"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0740912243", bankCode: "50010700", countryCode: "de").0, "Rule B7.13"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0893524479", bankCode: "50010700", countryCode: "de").0, "Rule B7.14"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0132572975", bankCode: "10050000", countryCode: "de").0, "Rule B8.5"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("9000412340", bankCode: "10050000", countryCode: "de").0, "Rule B8.9"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("9310305011", bankCode: "10050000", countryCode: "de").0, "Rule B8.10"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0132572975", bankCode: "10050000", countryCode: "de").0, "Rule B8.15"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("9000412340", bankCode: "10050000", countryCode: "de").0, "Rule B8.16"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("9310305011", bankCode: "10050000", countryCode: "de").0, "Rule B8.17"); // must fail

    // B9
    XCTAssertFalse(IBANtools.isValidAccount("0", bankCode: "11111134", countryCode: "de").0, "Rule B9.0");
    ...
    XCTAssertFalse(IBANtools.isValidAccount("43025432", bankCode: "11111134", countryCode: "de").0, "Rule B9.7"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("61256523", bankCode: "11111134", countryCode: "de").0, "Rule B9.9"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("54352684", bankCode: "11111134", countryCode: "de").0, "Rule B9.10"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("2356412", bankCode: "11111134", countryCode: "de").0, "Rule B9.14"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("5435886", bankCode: "11111134", countryCode: "de").0, "Rule B9.15"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("9435414", bankCode: "11111134", countryCode: "de").0, "Rule B9.16"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("82335729", bankCode: "130 511 72", countryCode: "de").0, "Rule C0.3"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("29837521", bankCode: "130 511 72", countryCode: "de").0, "Rule C0.4"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0132572975", bankCode: "13051042", countryCode: "de").0, "Rule C0.8"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("3038752371", bankCode: "13051042", countryCode: "de").0, "Rule C0.9"); // must fail

    // C1
    XCTAssertFalse(IBANtools.isValidAccount("0", bankCode: "50010517", countryCode: "de").0, "Rule C1.0");
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0478046340", bankCode: "50010517", countryCode: "de").0, "Rule C1.7"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0701625730", bankCode: "50010517", countryCode: "de").0, "Rule C1.8"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0701625440", bankCode: "50010517", countryCode: "de").0, "Rule C1.9"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0882095130", bankCode: "50010517", countryCode: "de").0, "Rule C1.10"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("5432112341", bankCode: "50010517", countryCode: "de").0, "Rule C1.16"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("5543223458", bankCode: "50010517", countryCode: "de").0, "Rule C1.17"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("5654334565", bankCode: "50010517", countryCode: "de").0, "Rule C1.18"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("5765445672", bankCode: "50010517", countryCode: "de").0, "Rule C1.19"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("5876556780", bankCode: "50010517", countryCode: "de").0, "Rule C1.20"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0328705282", bankCode: "21450000", countryCode: "de").0, "Rule C2.6"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("9024675131", bankCode: "21450000", countryCode: "de").0, "Rule C2.7"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0328705282", bankCode: "21450000", countryCode: "de").0, "Rule C2.10"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("9024675131", bankCode: "21450000", countryCode: "de").0, "Rule C2.11"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("17002", bankCode: "25060180", countryCode: "de").0, "Rule C3.4"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("123451", bankCode: "25060180", countryCode: "de").0, "Rule C3.5"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("122448", bankCode: "25060180", countryCode: "de").0, "Rule C3.6"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("9000734028", bankCode: "25060180", countryCode: "de").0, "Rule C3.10"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("9000733227", bankCode: "25060180", countryCode: "de").0, "Rule C3.11"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("9000731120", bankCode: "25060180", countryCode: "de").0, "Rule C3.12"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0000000017", bankCode: "29030400", countryCode: "de").0, "Rule C4.4"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0000292933", bankCode: "29030400", countryCode: "de").0, "Rule C4.5"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0000094459", bankCode: "29030400", countryCode: "de").0, "Rule C4.6"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("9000726558", bankCode: "29030400", countryCode: "de").0, "Rule C4.10"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("9001733457", bankCode: "29030400", countryCode: "de").0, "Rule C4.11"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("9000732000", bankCode: "29030400", countryCode: "de").0, "Rule C4.12"); // must fail

    // C5
    XCTAssertFalse(IBANtools.isValidAccount("0", bankCode: "20050000", countryCode: "de").0, "Rule C5.0");
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0000302589", bankCode: "20050000", countryCode: "de").0, "Rule C5.3"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0000507336", bankCode: "20050000", countryCode: "de").0, "Rule C5.4"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0302555000", bankCode: "20050000", countryCode: "de").0, "Rule C5.7"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0302589000", bankCode: "20050000", countryCode: "de").0, "Rule C5.8"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("1000061457", bankCode: "20050000", countryCode: "de").0, "Rule C5.19"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("1000061498", bankCode: "20050000", countryCode: "de").0, "Rule C5.20"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("4864446015", bankCode: "20050000", countryCode: "de").0, "Rule C5.21"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("4865038012", bankCode: "20050000", countryCode: "de").0, "Rule C5.22"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("5000001028", bankCode: "20050000", countryCode: "de").0, "Rule C5.23"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("5000001075", bankCode: "20050000", countryCode: "de").0, "Rule C5.24"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("6450008150", bankCode: "20050000", countryCode: "de").0, "Rule C5.25"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("6542812818", bankCode: "20050000", countryCode: "de").0, "Rule C5.26"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("9000110012", bankCode: "20050000", countryCode: "de").0, "Rule C5.27"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("9000300310", bankCode: "20050000", countryCode: "de").0, "Rule C5.28"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("3081000783", bankCode: "20050000", countryCode: "de").0, "Rule C5.31"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("3081308871", bankCode: "20050000", countryCode: "de").0, "Rule C5.32"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0525111212", bankCode: "10050005", countryCode: "de").0, "Rule C6.21"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0091423614", bankCode: "10050005", countryCode: "de").0, "Rule C6.22"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("1082311275", bankCode: "10050005", countryCode: "de").0, "Rule C6.23"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("1000118821", bankCode: "10050005", countryCode: "de").0, "Rule C6.24"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("2004306518", bankCode: "10050005", countryCode: "de").0, "Rule C6.25"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("2016001206", bankCode: "10050005", countryCode: "de").0, "Rule C6.26"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("3462816371", bankCode: "10050005", countryCode: "de").0, "Rule C6.27"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("3622548632", bankCode: "10050005", countryCode: "de").0, "Rule C6.28"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("4232300158", bankCode: "10050005", countryCode: "de").0, "Rule C6.29"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("4000456126", bankCode: "10050005", countryCode: "de").0, "Rule C6.30"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("5002684526", bankCode: "10050005", countryCode: "de").0, "Rule C6.31"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("5564123850", bankCode: "10050005", countryCode: "de").0, "Rule C6.32"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("6295473774", bankCode: "10050005", countryCode: "de").0, "Rule C6.33"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("6640806317", bankCode: "10050005", countryCode: "de").0, "Rule C6.34"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("7000062022", bankCode: "10050005", countryCode: "de").0, "Rule C6.35"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("7006003027", bankCode: "10050005", countryCode: "de").0, "Rule C6.36"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("8348300002", bankCode: "10050005", countryCode: "de").0, "Rule C6.37"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("8654216984", bankCode: "10050005", countryCode: "de").0, "Rule C6.38"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("9000641509", bankCode: "10050005", countryCode: "de").0, "Rule C6.39"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("9000260986", bankCode: "10050005", countryCode: "de").0, "Rule C6.40"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("1234517892", bankCode: "76026000", countryCode: "de").0, "Rule C7.9"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("987614325", bankCode: "76026000", countryCode: "de").0, "Rule C7.10"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("1234567890", bankCode: "21750000", countryCode: "de").0, "Rule C8.5"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("9012345678", bankCode: "21750000", countryCode: "de").0, "Rule C8.6"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("1234567890", bankCode: "21750000", countryCode: "de").0, "Rule C8.10"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("9012345678", bankCode: "21750000", countryCode: "de").0, "Rule C8.11"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("1234567890", bankCode: "21750000", countryCode: "de").0, "Rule C8.14"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("9012345678", bankCode: "21750000", countryCode: "de").0, "Rule C8.15"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("3456789012", bankCode: "59252046", countryCode: "de").0, "Rule C9.3"); // must fail

    XCTAssert(IBANtools.isValidAccount("0123456789", bankCode: "59252046", countryCode: "de").0, "Rule C9.6");
    XCTAssertFalse(IBANtools.isValidAccount("1234567890", bankCode: "59252046", countryCode: "de").0, "Rule C9.7"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("9012345678", bankCode: "59252046", countryCode: "de").0, "Rule C9.8"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("6100272885", bankCode: "86055592", countryCode: "de").0, "Rule D0.4"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("6100273377", bankCode: "86055592", countryCode: "de").0, "Rule D0.5"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("6100274012", bankCode: "86055592", countryCode: "de").0, "Rule D0.6"); // must fail

    // D1
    XCTAssertFalse(IBANtools.isValidAccount("0", bankCode: "10050006", countryCode: "de").0, "Rule D1.0");
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0000260986", bankCode: "10050006", countryCode: "de").0, "Rule D1.10"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("1062813622", bankCode: "10050006", countryCode: "de").0, "Rule D1.11"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("2256412314", bankCode: "10050006", countryCode: "de").0, "Rule D1.12"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("3012084101", bankCode: "10050006", countryCode: "de").0, "Rule D1.13"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("4006003027", bankCode: "10050006", countryCode: "de").0, "Rule D1.14"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("5814500990", bankCode: "10050006", countryCode: "de").0, "Rule D1.15"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("6128462594", bankCode: "10050006", countryCode: "de").0, "Rule D1.16"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("7000062035", bankCode: "10050006", countryCode: "de").0, "Rule D1.17"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("8003306026", bankCode: "10050006", countryCode: "de").0, "Rule D1.18"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("9000641509", bankCode: "10050006", countryCode: "de").0, "Rule D1.19"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("6414241", bankCode: "70120500", countryCode: "de").0, "Rule D2.7"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("179751314", bankCode: "70120500", countryCode: "de").0, "Rule D2.8"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("1600166307", bankCode: "59052020", countryCode: "de").0, "Rule D3.4"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("6025017009", bankCode: "59052020", countryCode: "de").0, "Rule D3.10"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("6028267003", bankCode: "59052020", countryCode: "de").0, "Rule D3.11"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("6019835001", bankCode: "59052020", countryCode: "de").0, "Rule D3.12"); // must fail

    // D4
    XCTAssertFalse(IBANtools.isValidAccount("0", bankCode: "10050007", countryCode: "de").0, "Rule D4.0");
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0359432843", bankCode: "10050007", countryCode: "de").0, "Rule D4.10"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("1000062023", bankCode: "10050007", countryCode: "de").0, "Rule D4.11"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("2204271250", bankCode: "10050007", countryCode: "de").0, "Rule D4.12"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("3051681017", bankCode: "10050007", countryCode: "de").0, "Rule D4.13"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("4000123456", bankCode: "10050007", countryCode: "de").0, "Rule D4.14"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("5212744564", bankCode: "10050007", countryCode: "de").0, "Rule D4.15"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("6286420010", bankCode: "10050007", countryCode: "de").0, "Rule D4.16"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("7859103459", bankCode: "10050007", countryCode: "de").0, "Rule D4.17"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("8003306026", bankCode: "10050007", countryCode: "de").0, "Rule D4.18"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("9916524534", bankCode: "10050007", countryCode: "de").0, "Rule D4.19"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("3299632008", bankCode: "20690500", countryCode: "de").0, "Rule D5.4"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("1999204293", bankCode: "20690500", countryCode: "de").0, "Rule D5.5"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0399242139", bankCode: "20690500", countryCode: "de").0, "Rule D5.6"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("8623420004", bankCode: "20690500", countryCode: "de").0, "Rule D5.11"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0001123458", bankCode: "20690500", countryCode: "de").0, "Rule D5.12"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0001123458", bankCode: "20690500", countryCode: "de").0, "Rule D5.15"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0000100084", bankCode: "20690500", countryCode: "de").0, "Rule D5.18"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0000100085", bankCode: "20690500", countryCode: "de").0, "Rule D5.19"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("3615071237", bankCode: "22151730", countryCode: "de").0, "Rule D6.4"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("6039267013", bankCode: "22151730", countryCode: "de").0, "Rule D6.5"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("6039316014", bankCode: "22151730", countryCode: "de").0, "Rule D6.6"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("7004017653", bankCode: "22151730", countryCode: "de").0, "Rule D6.10"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("9002720007", bankCode: "22151730", countryCode: "de").0, "Rule D6.11"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("9017483524", bankCode: "22151730", countryCode: "de").0, "Rule D6.12"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0501006102", bankCode: "57020500", countryCode: "de").0, "Rule D7.9"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0231307867", bankCode: "57020500", countryCode: "de").0, "Rule D7.10"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0301005331", bankCode: "57020500", countryCode: "de").0, "Rule D7.11"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0330034104", bankCode: "57020500", countryCode: "de").0, "Rule D7.12"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0420001302", bankCode: "57020500", countryCode: "de").0, "Rule D7.13"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0135638809", bankCode: "57020500", countryCode: "de").0, "Rule D7.14"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0202005939", bankCode: "57020500", countryCode: "de").0, "Rule D7.15"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0601006977", bankCode: "57020500", countryCode: "de").0, "Rule D7.16"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("3012084101", bankCode: "27020000", countryCode: "de").0, "Rule D8.4"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("1062813622", bankCode: "27020000", countryCode: "de").0, "Rule D8.5"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0000260986", bankCode: "27020000", countryCode: "de").0, "Rule D8.6"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("6543217890", bankCode: "50120383", countryCode: "de").0, "Rule D9.5"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0543216789", bankCode: "50120383", countryCode: "de").0, "Rule D9.6"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("6543217890", bankCode: "50120383", countryCode: "de").0, "Rule D9.10"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0543216789", bankCode: "50120383", countryCode: "de").0, "Rule D9.11"); // must fail
    ...
    XCTAssertFalse(IBANtools.isValidAccount("1100789043", bankCode: "50120383", countryCode: "de").0, "Rule D9.14"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("1100914032", bankCode: "50120383", countryCode: "de").0, "Rule D9.15"); // must fail

    // E0
    XCTAssertFalse(IBANtools.isValidAccount("0", bankCode: "20120400", countryCode: "de").0, "Rule E0.0");
    ...
    XCTAssertFalse(IBANtools.isValidAccount("1234769013", bankCode: "20120400", countryCode: "de").0, "Rule E0.5"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("2710014", bankCode: "20120400", countryCode: "de").0, "Rule E0.6"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("9741015011", bankCode: "20120400", countryCode: "de").0, "Rule E0.7"); // must fail

    // E1
    XCTAssertFalse(IBANtools.isValidAccount("0", bankCode: "50131000", countryCode: "de").0, "Rule E1.0");
    ...
    XCTAssertFalse(IBANtools.isValidAccount("0150013107", bankCode: "50131000", countryCode: "de").0, "Rule E1.5"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0200035101", bankCode: "50131000", countryCode: "de").0, "Rule E1.6"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0081313890", bankCode: "50131000", countryCode: "de").0, "Rule E1.7"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("4268550840", bankCode: "50131000", countryCode: "de").0, "Rule E1.8"); // must fail
    XCTAssertFalse(IBANtools.isValidAccount("0987402008", bankCode: "50131000", countryCode: "de").0, "Rule E1.9"); // must fail
